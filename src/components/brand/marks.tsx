...
/**
 * Official 〽️ glyph. Lopsided M / rollercoaster — the mark people already type.
 * One-color stroke so it prints, sews, and recolors.
 */
export const MARK_D =
...
export function Spark({ className, title = "BIG CRUISE 〽️" }: MarkProps) {
  return (
...
export function MidnightMark({ className, title = "BIG CRUISE midnight mark" }: MarkProps) {
  return (
...
export function MarkSignature({ className }: MarkProps) {
  return <Spark className={className} title="The 〽️" />;
}
...
export const concepts = [
  {
    ...
    idea: "A continuous route that always returns to the people. Three lobes for Cruise, Connect, Create. 〽️ in the centre.",
    Mark: MarkLoop,
  },
  {
    id: "02",
    name: "The BC Monogram",
    idea: "B and C share a spine. The 〽️ replaces the middle bar. A clothing-label mark.",
    Mark: MarkMonogram,
  },
  {
    id: "03",
    name: "The Connected Mark",
    idea: "A chain-link room. Nodes for members, the 〽️ in the centre for the live conversation.",
    Mark: MarkConnected,
  },
  {
    id: "04",
    name: "The Motion Mark",
    idea: "An italic C built from three speed lanes. The 〽️ is the terminal.",
    Mark: MarkMotion,
  },
  {
    id: "05",
    name: "The Community Seal",
    idea: "A streetwear patch. Eight ticks for the clock of a midnight Space. 〽️ at the core.",
    Mark: MarkSeal,
  },
  {
    id: "06",
    name: "The Negative Cut",
    idea: "A C carved out of midnight. The 〽️ sits in the remaining mass — hidden until you look.",
    Mark: MarkNegative,
  },
  {
    id: "07",
    name: "The Digital Street Mark",
    idea: "Vinyl-cut 〽️ on a squircle. Danfo sticker construction, built for an app icon.",
    Mark: MarkDigital,
  },
  {
    id: "08",
    name: "The 〽️",
    idea: "The mark members already type. A lopsided M — two peaks, a dip, a drop to the right.",
    Mark: MarkSignature,
    featured: true,
  },
] as const;
